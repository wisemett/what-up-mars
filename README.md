...
[Click to watch!](https://www.youtube.com/watch?v=E5333KYviI0&feature=youtu.be)
...
3. server 폴더에 `.env` 파일 생성 (내용 문의: ✉️ reddream08@gmail.com)

4. client 폴더에서 `npm run build` 실행

5. server 폴더에서 `npm run dev` 실행
